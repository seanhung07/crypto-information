...
function TradingView() {
    return(
        ...
        <TopNavbar title="TradingView"/>
            <AdvancedChart widgetPropsAny={{"hotlist": true,"calendar": true,"details": true,"style": "1","locale": "zh_TW", "width": "100%","height": "800","symbol": "BINANCE:ETHUSDT","watchlist": [
                ...
                ,"BINANCE:XLMUSDT","BINANCE:DASHUSDT"]}} widgetProps={{"interval": "15"}}/>
        </ThemeProvider>
    )
