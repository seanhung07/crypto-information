    ...
    return(
        ...
        <TopNavbar title="TradingView"/>
            <AdvancedChart widgetPropsAny={{"hotlist": true,"calendar": true,"details": true,"style": "1","locale": "zh_TW", "width": "100%","height": "760","symbol": "BINANCE:ETHUSDT","watchlist": [
                ...
                "BINANCE:CRVUSDT","BINANCE:KSMUSDT","BINANCE:FTTUSDT","BINANCE:SUSHIUSDT","HUOBI:FLOWUSDT","BINANCE:DOTUSDT","BINANCE:ALICEUSDT","BINANCE:CHRUSDT","BINANCE:LUNAUSDT","BINANCE:RUNEUSDT","BINANCE:BAKEUSDT","BINANCE:VETUSDT","BINANCE:CHZUSDT"
                ,"BINANCE:XLMUSDT","BINANCE:DASHUSDT","OKEX:OKBUSDT","BINANCE:BTCUSDTPERP"]}} widgetProps={{"interval": "15"}}/>
        </ThemeProvider>
    )
